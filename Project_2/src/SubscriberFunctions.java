...
public class SubscriberFunctions {
	...
	private static PositionDataReader CreatePositionReader(DomainParticipant participant, Subscriber subscriber, String filter, String[] params) {
		...
		ContentFilteredTopic positionTopicFiltered = participant.create_contentfilteredtopic_with_filter("P2464_ischultz:POS", positionTopic, filter, parameters, DomainParticipant.STRINGMATCHFILTER_NAME);
	...
	private static AccidentDataReader CreateAccidentReader(DomainParticipant participant, Subscriber subscriber, String filter, String[] params) {
		...
		ContentFilteredTopic accidentTopicFiltered = participant.create_contentfilteredtopic_with_filter("P2464_ischultz:ACC", accidentTopic, filter, parameters, DomainParticipant.STRINGMATCHFILTER_NAME);

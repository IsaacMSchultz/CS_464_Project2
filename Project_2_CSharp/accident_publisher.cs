...
bin\<Debug|Release>\Accident_publisher <domain_id> <sample_count>
bin\<Debug|Release>\Accident_subscriber <domain_id> <sample_count>
*/
...
public class AccidentPublisher {
    ...
    static void publish(int domain_id, int sample_count) {
        ...
        System.String type_name = AccidentTypeSupport.get_type_name();
        try {
        ...
        (AccidentDataWriter)writer;

        // --- Write --- //

        /* Create data sample for writing */
        Accident instance = AccidentTypeSupport.create_data();
        if (instance == null) {
            shutdown(participant);
            throw new ApplicationException(
                "AccidentTypeSupport.create_data error");
        }
        ...
        */
        ...
        ++count) {
            Console.WriteLine("Writing Accident, count {0}", count);

            /* Modify the data to be sent here */

            try {
                Accident_writer.write(instance, ref instance_handle);
            }
            catch(DDS.Exception e) {
        ...
        */
        ...
        /* Delete data sample */
        try {
            AccidentTypeSupport.delete_data(instance);
        } catch(DDS.Exception e) {
            Console.WriteLine(
                "AccidentTypeSupport.delete_data error: {0}", e);
        }

...
public class AccidentSubscriber {
    ...
    public class AccidentListener : DDS.DataReaderListener {
        ...
        public override void on_data_available(DDS.DataReader reader) {
            ...
            for (int i = 0; i < data_length; ++i) {
                if (info_seq.get_at(i).valid_data) {
                    AccidentTypeSupport.print_data(data_seq.get_at(i));
                }
            }

            try {
                Accident_reader.return_loan(data_seq, info_seq);
            }
            catch(DDS.Exception e) {
        ...
        public AccidentListener() {
            data_seq = new AccidentSeq();
            info_seq = new DDS.SampleInfoSeq();
        }

        private AccidentSeq data_seq;
    ...
    static void subscribe(int domain_id, int sample_count) {
        ...
        ++count) {
            Console.WriteLine(
                "Accident subscriber sleeping for {0} sec...",
            receive_period / 1000);

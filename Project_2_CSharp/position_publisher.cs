...
bin\<Debug|Release>\Position_publisher <domain_id> <sample_count>
bin\<Debug|Release>\Position_subscriber <domain_id> <sample_count>
*/
...
public class PositionPublisher {
    ...
    static void publish(int domain_id, int sample_count) {
        ...
        System.String type_name = PositionTypeSupport.get_type_name();
        try {
        ...
        Position instance = PositionTypeSupport.create_data();
        if (instance == null) {
            shutdown(participant);
            throw new ApplicationException(
                "PositionTypeSupport.create_data error");
        }
        ...
        */
        ...
        ++count) {
            Console.WriteLine("Writing Position, count {0}", count);

            /* Modify the data to be sent here */

            try {
                Position_writer.write(instance, ref instance_handle);
            }
            catch(DDS.Exception e) {
        ...
        /*
        try {
            Position_writer.unregister_instance(
        ...
        */
        ...
        /* Delete data sample */
        try {
            PositionTypeSupport.delete_data(instance);
        } catch(DDS.Exception e) {
            Console.WriteLine(
                "PositionTypeSupport.delete_data error: {0}", e);
        }

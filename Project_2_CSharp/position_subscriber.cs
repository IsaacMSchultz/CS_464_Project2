...
public class PositionSubscriber {
    ...
    public class PositionListener : DDS.DataReaderListener {
        ...
        public override void on_data_available(DDS.DataReader reader) {
            ...
            for (int i = 0; i < data_length; ++i) {
                if (info_seq.get_at(i).valid_data) {
                    PositionTypeSupport.print_data(data_seq.get_at(i));
                }
            }

            try {
                Position_reader.return_loan(data_seq, info_seq);
            }
            catch(DDS.Exception e) {
        ...
        public PositionListener() {
            data_seq = new PositionSeq();
            info_seq = new DDS.SampleInfoSeq();
        }

        private PositionSeq data_seq;
    ...
    static void subscribe(int domain_id, int sample_count) {
        ...
        PositionListener reader_listener =
        ...
        ++count) {
            Console.WriteLine(
                "Position subscriber sleeping for {0} sec...",
            receive_period / 1000);
